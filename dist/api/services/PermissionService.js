    ...
    hasForeignObjects: function hasForeignObjects(objects, user) {
        if (_.isArray(objects)) {
            return _.any(objects, function (object) {
                return PermissionService.hasForeignObjects(object, user);
            });
        }

        var predicate = PermissionService.isForeignObject(user.id);
        ...
        object = _.mapValues(object, function (value, key) {
            if (_.isObject(value)) {
                return [value];
        ...
        return !!_.find(object, function (value, key) {
            if (_.isObject(value)) {
